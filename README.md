...
| Écran de saisie | Historique |
|---|---|
| ![Écran de saisie d'humeur, avec le niveau "Terrible" sélectionné et le message de confirmation "Humeur enregistrée !"](assets/screenshots/ulteam4.jpg) | ![Écran historique avec le résumé (9 entrées, moyenne 2.3/5) et la liste triée de la plus récente à la plus ancienne](assets/screenshots/ulteam5.jpg) |
